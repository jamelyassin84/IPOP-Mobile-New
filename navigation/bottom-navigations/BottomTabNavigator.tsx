...
export function AboutNavigator() {
	return (
		<About.Navigator>
			<About.Screen name="About Us" component={AboutScreen} options={{ headerShown: false }} />
		</About.Navigator>
	)
}
...
export function ProgramAreaNavigator() {
	return (
		<Program.Navigator>
			<Program.Screen name="Program Areas" component={ProgramAreaScreen} options={{ headerShown: false }} />
		</Program.Navigator>
	)
}
...
export function ServicesNavigator() {
	return (
		<Services.Navigator>
			<Services.Screen name="Services Offered" component={ServicesScreen} options={{ headerShown: false }} />
		</Services.Navigator>
	)
}
...
export function MenuNavigator() {
	return (
		<Menu.Navigator>
			<Menu.Screen name="More" component={MenuScreen} options={{ headerShown: false }} />
		</Menu.Navigator>
	)
}

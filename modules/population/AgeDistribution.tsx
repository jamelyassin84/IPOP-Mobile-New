...
const AgeDistribution: FC<Props> = ( { route }: any ) => {
                    ...
                    <View style={style.tbody}>
                        {
                            ageDistribution.map( ( item: any, index: number ) => (
                                <View key={index} style={[ style.row, { backgroundColor: isOdd( index ) ? 'rgba(150,150,150,.2)' : Colors[ colorScheme ].background } ]}>
                                    ...
                                    <View style={style.column} >
                                        <Text style={[ style.center, { color: Colors[ colorScheme ].text } ]}>{getPercent( item[ '0-14' ],
                                            item.hh_population )}</Text>
                                    </View>
                                    <View style={style.column} >
                                        <Text style={[ style.center, { color: Colors[ colorScheme ].text } ]}>{item[ '15-64' ]}</Text>
                                    </View>
                                    <View style={style.column} >
                                        <Text style={[ style.center, { color: Colors[ colorScheme ].text } ]}>{getPercent( item[ '15-64' ],
                                            item.hh_population )}</Text>
                                    </View>
                                    <View style={style.column} >
                                    ...
                                    <View style={style.column} >
                                        <Text style={[ style.center, { color: Colors[ colorScheme ].text } ]}>{getPercent( item[ '65_and_over' ],
                                            item.hh_population )}</Text>
                                    </View>
                                    <View style={style.column} >

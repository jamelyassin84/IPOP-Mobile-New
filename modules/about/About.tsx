		...
		<Container>
			...
			>
				{AboutNavs.map((nav: AboutNavType, index: number) => (
					<TouchableOpacity key={index} style={style.container} onPress={() => navigation.navigate(nav.route)}>
						<MaterialCommunityIcons name={nav.icon} size={35} color={'#1049A2'} style={style.icon} />

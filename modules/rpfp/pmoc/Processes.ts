...
export function AgeGroup(data: any) {
	data = data[0]
	let chart: any = ChartFormat
	chart.labels = ['15-19', '20-24', '25-29 ', '30-34', '35-39', '40-44', '45+']
	chart.female = [
	...
	chart.total = [
		parseInt(data['15_to_19_female'] || 0) + parseInt(data['15_to_19_male'] || 0),
		parseInt(data['20_to_24_female'] || 0) + parseInt(data['20_to_24_male'] || 0),
		parseInt(data['25_to_29_female'] || 0) + parseInt(data['25_to_29_male'] || 0),
		parseInt(data['30_to_34_female'] || 0) + parseInt(data['30_to_34_male'] || 0),
		parseInt(data['35_to_39_female'] || 0) + parseInt(data['35_to_39_male'] || 0),
		parseInt(data['40_to_44_female'] || 0) + parseInt(data['40_to_44_male'] || 0),
		parseInt(data['45_and_above_female'] || 0) + parseInt(data['45_and_above_male'] || 0),
	]
	return chart
}
...
export function EmploymentStatus(data: any) {
	data = data[0]
	let chart: any = ChartFormat
	chart.labels = ['Students', 'Employed', 'Unemployed']
...
export function KnowLedgeOnFP(data: any) {
	data = data[0]
	let chart: any = ChartFormat
	chart.labels = ['Male', 'Female', 'Total']
	chart.male = [data.males || 0]
	chart.female = [data.females || 0]
	chart.total = [parseInt(data.males) || 0 + parseInt(data.females) || 0]
	return chart
}
...
export function CivilStatus(data: any) {
	data = data[0]
	let chart: any = ChartFormat
	chart.labels = ['Single', 'Live-in', 'Widow', 'Separated']
...
export function AverageMonthlyIncome(data: any) {
	data = data[0]
	let chart: any = ChartFormat
	chart.labels = ['0', '-5k ', '5k-9k', '1k-14k', '15k-19k', '20k-24k', '25k+']
	chart.male = [
